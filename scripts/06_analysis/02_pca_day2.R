...
var_labels <- c(
  ...
  "LEVEL1_TREATMENTS_D1_SAFE_0" = "Mechanical ventilation, inotropes, or renal replacement therapy on day 1",
  "LEVEL2_TREATMENTS_D1_SAFE_0" = "CPAP or IV fluid bolus on day 1",
  "LEVEL3_TREATMENTS_D1_SAFE_0" = "ICU admission with clinical reason on day 1",
  "LEVEL4_TREATMENTS_D1_SAFE_0" = "O2 via face or nasal cannula on day 1",
  "LEVEL5_TREATMENTS_D1_SAFE_0" = "Non-bolused IV fluids on day 1"
)
...
# Median PC1–PC3 by treatment (Day 2)
...
p <- ggplot() +
  ...
  labs(
    title = "Variable-Importance Structure Across Day-2 Treatment Models (PCA)",
    subtitle = "Points represent ensemble models, coloured by the Day-2 treatment it was trained to predict.",
    x = "PC1",
    y = "PC2",
    colour = "Day 2 Treatment"
  ) +
  theme_classic() +
  theme(
